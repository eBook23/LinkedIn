...
<body>
  <div class="x-nav">
    ...
    <div class="x-body">
      ...
      <div class="layui-row">
        <form class="layui-form layui-col-md12 x-so" action="Resume/list">
          <input type="text" name="cname"  placeholder="输入简历" autocomplete="off" class="layui-input">
        	...
        	<c:forEach var="r" items="${resumes}">
          	<tr>
	            ...
	            <td class="td-manage">
	              ...
	              <a title="删除" href="Resume/remove?rno=${r.UUID}&userid=${r.userid}">
