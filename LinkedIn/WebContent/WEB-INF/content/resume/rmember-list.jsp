        ...
        <tbody>
        	<c:forEach var="u" items="${users}">
          	<tr>
	            ...
	            <td>${u.time}</td>
	            <td class="td-status">
	              <span class="layui-btn layui-btn-normal layui-btn-mini">${u.power}</span>
	             </td>
	            <td class="td-manage">
	            	&nbsp&nbsp
	              <a title="查看" href="Resume/list?userid=${u.UUID}">
	                <i class="layui-icon">&#xe642;查看简历</i>
	              </a>&nbsp&nbsp&nbsp
	              <a title="添加" href="Resume/toadd?userid=${u.UUID}">
	                <i class="layui-icon">&#xe640;添加简历</i>
	              </a>
	            </td>
          	</tr>
          </c:forEach>
